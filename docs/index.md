...
| 3    | 14-Feb | 54-4011 | Backpropagation                                                             | {% comment %} [backprop-handouts.pdf](handouts/backprop-handouts.pdf)   {% endcomment %}                                                                             |  [Learning representations by back-propagating errors](handouts/nature_article.pdf)   |  {% comment %} (https://southampton.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=2c08987a-fba1-46fa-8c06-acd300c3e9aa) {% endcomment %}|

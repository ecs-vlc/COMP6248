...
\begin{center}
  ...
  \blfootnote{Daniela Mihai and Jonathon Hare. Avoiding hashing and encouraging visual semantics in referential emergent language games. EmeComm\@NeurIPS 2019. https://arxiv.org/abs/1911.05546}
\end{center}
...
\begin{center}
$\softmax(z)_i = \frac{e^{z_i}}{\sum_{j=1}^K e^{z_j}} \;\;\;\;\;\;\; \forall i = 1, 2, \dots, K$  
\end{center}
...
\begin{itemize}
  ...
  \item Note: $\frac{\partial \softmax(z)_i }{z_i} = z_i (1 - z_i)$
\end{itemize}

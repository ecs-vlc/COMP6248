...
\\[1em]
\pause
$\implies$ simple neural networks can represent a wide variety of interesting functions when given appropriate parameters. \footnote{Visual Proof: http://neuralnetworksanddeeplearning.com/chap4.html}
\end{frame}
%-------------------------------------------------------------%

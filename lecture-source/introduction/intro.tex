...
\begin{frame}
	...
	\begin{tabular}{ c c c }
		 ...
		 Lab 4  & 26/02/20 & NNs with PyTorch and Torchbearer \\
 		 ...
 		 Lab 7  & 18/03/20 & RNNs, Sequence Prediction and Embeddings \\
 		 \hline
 		 & Break & \\
		 \hline
...
\begin{frame}
	...
	\item<+-> Fundamentals of Matrix Algebra (matrix-matrix, matrix-vector and matrix-scalar operations, inverse, determinant, rank, Eigendecomposition, SVD), Probability \& Statistics (1st-order summary statistics, simple continous and discrete probability distributions, expected values, etc) and Multivariable Calculus (partial differentiation, chain-rule)

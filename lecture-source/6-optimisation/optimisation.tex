...
It's common for the `leaky' average (the `velocity', $v_t$) to be a weighted average of the instananeous gradient $g_t$ and the past velocity\footnote{There are quite a few variants of this; here we're following the PyTorch variant}:

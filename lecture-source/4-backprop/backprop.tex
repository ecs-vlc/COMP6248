...
\begin{itemize}
  ...
  \begin{itemize}
     ...
     \item<+-> multiple $\bm x_i$  by 1000, and the gradients also increase by 1000
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \end{itemize}
    \item<+-> Maximum gradient is achieved when $x=0$ ($x=0.5, dx=0.25$)
    \begin{itemize}
...
\begin{frame}[fragile]\frametitle{Mini-batch Gradient Descent}

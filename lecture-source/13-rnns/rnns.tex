...
\begin{frame}
  ...
  \tiny{A lot of the ideas in this lecture come from Andrej Karpathy's blog post on the Unreasonable Effectiveness of RNNs (\url{http://karpathy.github.io/2015/05/21/rnn-effectiveness/}). Many of the images and animations and were made by Adam Pr\"ugel-Bennett.}
\end{frame}
%-------------------------------------------------------------%
